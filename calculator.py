...
#Result
equal = Button(app,fg="white",bg="#2B2422",text="=",padx=30,pady=30,command=button_equal).grid(row=4,column=1)

#Operations
plus = Button(app,fg="white",bg="#2B2422",text="+",padx=30,pady=30,command=button_plus).grid(row=1,column=4)
subtract = Button(app,fg="white",bg="#2B2422",text="-",padx=30,pady=30,command=button_rest).grid(row=2,column=4)
multiply = Button(app,fg="white",bg="#2B2422",text="x",padx=30,pady=30,command=button_multiply).grid(row=3,column=4)
divide = Button(app,fg="white",bg="#2B2422",text="/",padx=30,pady=30,command=button_divide).grid(row=4,column=4)
clear = Button(app,fg="white",bg="#2B2422",text="C",padx=30,pady=30,command=delete).grid(row=4,column=2)
